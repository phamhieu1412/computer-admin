...
const Manufacturers = () => {
  ...
  const { list, isFetching } = manufacturerReducer;
  ...
  const deleteItem = (id) => {
    dispatch(
      ManufacturerActions.deleteManufacturer(id, {
        onSuccess: (text) => {
  ...
  const addNewInfo = () => {
    ...
    dispatch(
      ManufacturerActions.createManufacturer(
        {
          name: infoEdit.name,
          image_url: "",
  ...
  return (
    <div>
      <div className="header-title">
        <h2 className="page-header">Nhà sản xuất</h2>
